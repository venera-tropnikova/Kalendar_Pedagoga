...
CE2_TP1_WEEK_SNAPSHOT = (
    ...
    ("5.3", "учебно-тренировочное занятие", "Выполняет упражнения для рук и плечевого пояса.", "педагогическое наблюдение за выполнением упражнений для рук и плечевого пояса"),
    ("5.3", "учебно-тренировочное занятие", "Выполняет упражнения для мышц шеи.", "педагогическое наблюдение за выполнением упражнений для мышц шеи"),
    ("5.3", "учебно-тренировочное занятие", "Выполняет упражнения для туловища, для ног.", "педагогическое наблюдение за выполнением упражнений для туловища, для ног"),
