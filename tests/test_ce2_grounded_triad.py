...
CE2_TP1_WEEK_SNAPSHOT = (
    ...
    ("1.3", "практикум по работе со снаряжением", "Укладывает рюкзаки, подгоняет снаряжение.", "педагогическое наблюдение за укладкой рюкзака и подгонкой снаряжения"),
    ("1.4", "туристский практикум", "Развертывает и свертывает лагерь (бивак).", "педагогическое наблюдение при развертывании и свертывании лагеря"),
    ...
    ("1.7", "туристский практикум", "Выполняет обязанности по должностям в период подготовки.", "педагогическое наблюдение за выполнением обязанностей по должностям в период подготовки"),
    ...
    ("1.10", "туристский практикум", "Выступает в туристских соревнованиях в качестве участника.", "педагогическое наблюдение за участием в туристских соревнованиях"),
    ("1.11", "практикум по подготовке отчёта", "Составляет отчёт о походе.", "проверка отчёта о походе"),
    ("2.1", "топографический практикум", "Определяет масштаб.", "практическое задание по определению масштаба"),
    ("2.2", "топографический практикум", "Распознаёт знаки.", "топографический диктант"),
    ...
    ("2.4", "топографический практикум", "Ориентирует карту по компасу.", "практическое задание по ориентированию карты по компасу"),
    ...
    ("2.6", "топографический практикум", "Отбирает основные контрольные ориентиры на карте по заданному маршруту.", "практическое задание по отбору основных контрольных ориентиров на карте по заданному маршруту"),
    ("2.7", "практикум по ориентированию", "Определяет стороны горизонта по местным предметам, по Солнцу. Имитация ситуации потери ориентировки. Действия по восстановлению местонахождения.", "практическое задание по определению сторон горизонта и восстановлению ориентировки"),
    ...
    ("4.1", "практикум по личной гигиене", "Применяет средства личной гигиены в походах и во время тренировочного процесса.", "педагогическое наблюдение за применением средств личной гигиены"),
