...
CE2_TP1_WEEK_SNAPSHOT = (
    ...
    ("1.4", "практикум по организации бивака", "Развертывает и свертывает лагерь (бивак).", "педагогическое наблюдение при развертывании и свертывании лагеря"),
    ...
    ("2.1", "практикум по работе с картой", "Определяет масштаб.", "практическое задание по определению масштаба"),
    ...
    ("2.6", "практикум по ориентированию", "Отбирает основные контрольные ориентиры на карте по заданному маршруту.", "практическое задание по отбору основных контрольных ориентиров на карте по заданному маршруту"),
