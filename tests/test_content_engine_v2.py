...
APPROVED_TP_TOPICS = (
    ...
    ("3.2", "Совершает прогулки и экскурсии по ближайшим окрестностям."),
...
APPROVED_TP_CONTROL_TYPE = {
    ...
    "5.4": ("педагогическое наблюдение за выполнением упражнений", "учебно-тренировочное занятие"),
}
...
def test_exercise_word_uses_performs_exercises() -> None:
    ...
    assert derived.assessment_method == "педагогическое наблюдение за выполнением упражнений"
...
AUDIT_REGRESSION_TOPICS = {
    ...
    "1.9": (
        "Отрабатывает технику преодоления естественных препятствий: склонов, подъёмов.",
        "педагогическое наблюдение за техникой преодоления препятствий",
    ),
    "2.2": (
        "Распознаёт знаки.",
...
STABLE_TP_TOPICS = {
    ...
    "2.7": (
        "Определяет стороны горизонта по местным предметам, по Солнцу.",
        "практическое задание по определению сторон горизонта",
        "практикум",
    ),
    "3.1": (
    ...
    "3.2": (
        "Совершает прогулки и экскурсии по ближайшим окрестностям.",
