...
APPROVED_TP_CONTROL_TYPE = {
    ...
    "1.4": ("педагогическое наблюдение при развертывании и свертывании лагеря", "туристский практикум"),
    ...
    "2.4": ("практическое задание по ориентированию карты по компасу", "топографический практикум"),
...
STABLE_TP_TOPICS = {
    ...
    "1.10": (
        ...
        "педагогическое наблюдение за участием в туристских соревнованиях",
        "туристский практикум",
    ),
    "1.11": (
