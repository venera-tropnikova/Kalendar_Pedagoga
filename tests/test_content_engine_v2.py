...
APPROVED_TP_TOPICS = (
    ...
    ("1.3", "Укладывает рюкзаки, подгоняет снаряжение, ухаживает за ним и ремонтирует его."),
    ("1.4", "Определяет места, пригодные для организации привалов и ночлегов, развертывает и свертывает лагерь (бивак), разжигает костёр."),
    ("1.5", "Составляет план подготовки похода и план-график движения, подготавливает личное и общественное снаряжение."),
...
APPROVED_TP_CONTROL_TYPE = {
    ...
    "1.3": ("педагогическое наблюдение за укладкой рюкзака, подгонкой снаряжения, уходом за ним и ремонтом", "практикум по работе со снаряжением"),
    "1.4": ("педагогическое наблюдение за выбором места для привалов и ночлегов, развертыванием и свертыванием лагеря и разжиганием костра", "практикум по организации бивака"),
    "1.5": ("проверка плана подготовки похода и плана-графика движения; педагогическое наблюдение за подготовкой личного и общественного снаряжения", "проектно-практическое занятие"),
    "1.6": ("проверка меню и списка продуктов; педагогическое наблюдение за приготовлением пищи на костре", "практикум по организации питания"),
    "1.8": ("педагогическое наблюдение за техникой движения", "учебно-тренировочное занятие на местности"),
    "2.4": ("практическое задание по ориентированию карты по компасу", "практикум по ориентированию"),
    "3.1": ("краеведческая викторина", "викторина"),
    "3.2": ("педагогическое наблюдение на экскурсии", "экскурсия"),
    "4.3": ("практическое задание по оказанию первой помощи условно пострадавшему", "практикум по оказанию первой помощи"),
...
def test_observation_control_follows_leading_action() -> None:
    ...
    assert derived.assessment_method == "педагогическое наблюдение за проведением наблюдений за ростом растений"
...
AUDIT_REGRESSION_TOPICS = {
    "1.2": (
        ...
        "устный опрос по роли туризма в подготовке к защите Родины, в выборе профессии и подготовке к предстоящей трудовой деятельности",
    ),
    "1.5": (
        "Составляет план подготовки похода и план-график движения, подготавливает личное и общественное снаряжение.",
        "проверка плана подготовки похода и плана-графика движения; педагогическое наблюдение за подготовкой личного и общественного снаряжения",
    ),
    "1.8": (
    ...
    "2.6": (
        "Отбирает основные контрольные ориентиры на карте по заданному маршруту, находит сходные (параллельные) ситуации и определяет способы привязки.",
        "практическое задание по отбору основных контрольных ориентиров на карте по заданному маршруту, отысканию сходных ситуаций и определению способов привязки",
    ),
    "4.1": (
        "Применяет средства личной гигиены в походах и во время тренировочного процесса, подбирает одежду и обувь для тренировок и походов, ухаживает за одеждой и обувью.",
        "педагогическое наблюдение за применением средств личной гигиены, подбором одежды и обуви и уходом за одеждой и обувью",
    ),
    "5.1": (
...
STABLE_TP_TOPICS = {
    ...
    "1.3": (
        ...
        "педагогическое наблюдение за укладкой рюкзака, подгонкой снаряжения, уходом за ним и ремонтом",
        "практикум по работе со снаряжением",
    ),
    "1.4": (
        "Определяет места, пригодные для организации привалов и ночлегов, развертывает и свертывает лагерь (бивак), разжигает костёр.",
        "педагогическое наблюдение за выбором места для привалов и ночлегов, развертыванием и свертыванием лагеря и разжиганием костра",
        "практикум по организации бивака",
    ),
    "1.6": (
        "Составляет меню и список продуктов для похода, готовит пищу на костре.",
        "проверка меню и списка продуктов; педагогическое наблюдение за приготовлением пищи на костре",
    ...
    "1.7": (
        ...
        "практикум по исполнению должностей",
    ),
    "1.10": (
    ...
    "2.1": (
        ...
        "практическое задание по определению масштаба и измерению расстояния на карте",
        "практикум по работе с картой",
    ),
    "2.4": (
    ...
    "3.3": (
        ...
        "краеведческий практикум",
    ),
    "3.4": (
        "Проводит краеведческие наблюдения.",
        "педагогическое наблюдение за проведением краеведческих наблюдений",
        "занятие-наблюдение",
    ),
    "4.2": (
        "Формирует походную медицинскую аптечку.",
        "проверка состава походной медицинской аптечки",
        "практикум по комплектованию аптечки",
    ),
    "4.3": (
    ...
    "4.4": (
        ...
        "проверка изготовленных носилок и волокуш; педагогическое наблюдение при разучивании способов транспортировки",
        "практикум по транспортировке пострадавшего",
    ),
    "5.2": (
        "Ведёт дневник самоконтроля.",
        "проверка дневника самоконтроля",
        "практикум по самоконтролю",
    ),
    "5.3": (
